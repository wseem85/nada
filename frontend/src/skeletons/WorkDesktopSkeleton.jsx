        ...
        <div className="grid grid-cols-[1fr_8fr_5fr] gap-6">
          ...
          <div className="flex flex-col space-y-4 max-h-[500px] overflow-y-hidden pr-2">
            {mockImages.map((_, index) => (
              ...
              >
                <div className="w-full h-16 bg-white rounded-md animate-pulse"></div>
              </div>
            ))}
          </div>
          ...
          <div className="rounded-lg p-4">
            {/* Main Image Skeleton */}
            <div className="w-full h-96 bg-white rounded-lg animate-pulse"></div>
          ...
          <div className="mt-8 md:block">
            {/* Title Skeleton */}
            <div className="h-8 w-3/4 bg-white rounded mx-auto animate-pulse mb-6"></div>
            ...
            <div className="text-center mt-6">
              <div className="h-12 w-full bg-white rounded-sm animate-pulse"></div>
            </div>
